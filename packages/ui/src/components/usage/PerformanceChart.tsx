  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2">
        <span className="text-sm text-slate-400">{t('usage.metric')}:</span>
        <Button
          variant={metric === 'speed' ? 'default' : 'outline'}
          size="sm"
          onClick={() => setMetric('speed')}
          className={`gap-1 ${metric === 'speed' ? 'bg-cyan-500/20 text-cyan-400 border border-cyan-500/50 hover:bg-cyan-500/30' : 'bg-slate-800/50 text-slate-300 border-slate-700/50 hover:bg-slate-700'}`}
        >
        ...
        <Button
          ...
          className={`gap-1 ${metric === 'latency' ? 'bg-cyan-500/20 text-cyan-400 border border-cyan-500/50 hover:bg-cyan-500/30' : 'bg-slate-800/50 text-slate-300 border-slate-700/50 hover:bg-slate-700'}`}
        >
          ...
          <LineChart data={chartData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
            ...
            <Tooltip
              contentStyle={{
                ...
                borderRadius: '8px',
                boxShadow: '0 4px 12px -1px rgba(0, 0, 0, 0.5)',
