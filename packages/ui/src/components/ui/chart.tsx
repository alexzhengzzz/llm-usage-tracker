...
export function formatChartNumber(value: number | undefined | null): string {
...
export function formatSpeed(tokensPerSec: number | undefined | null): string {
  if (tokensPerSec == null || isNaN(tokensPerSec)) return '-';
